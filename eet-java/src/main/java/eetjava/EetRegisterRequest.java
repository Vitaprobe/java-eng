...
public class EetRegisterRequest {
	...
	public static class Builder {
		...
		protected String _sslContextAlgorithm="TLSv1";
		protected String[] _sslEnabledProtocols=new String[] {"TLSv1", "TLSv1.1", "TLSv1.2"};
	...
	protected String generateSoapRequestInternal(Date dat_odesl_force, PrvniZaslani prvni_zaslani_force, String uuid_zpravy_force, Overeni overeni_force){
		try {
			...
			String sha1sum=loadTemplateFromResource("/eetjava/templates/sha1sum.txt");
			...
			String templateBody=loadTemplateFromResource("/eetjava/templates/template_body.txt",hashes.get("template_body"));
			String templateSignature=loadTemplateFromResource("/eetjava/templates/template_signature.txt",hashes.get("template_signature"));
			String templateRequest=loadTemplateFromResource("/eetjava/templates/template_request.txt",hashes.get("template_request"));
